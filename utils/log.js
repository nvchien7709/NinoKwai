...
module.exports.loader = (data, option) => {
  ...
  switch (option) {
    case 'warn':
      coloredData = gradient('#00FFFF' , '#00FF33' , '#FFCCFF' , '#ed3491', '#0000FF' , '#cb34ed' ,'#00FF00' , '#347bed' , '#00EE00').multiline('[ Nino ] - ' + data);
      console.log(chalk.bold(coloredData));
      break;
    case 'error':
      coloredData = chalk.bold.hex('#FF0000')('[ Nino ] - ') + chalk.bold.red(data);
      console.log(coloredData);
      break;
    default:
