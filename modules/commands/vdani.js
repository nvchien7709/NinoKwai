...
module.exports.handleEvent = async ({ api, event, Threads }) => {
  if (event.body.indexOf("vd")==0 || (event.body.indexOf("vdanime")==0) || event.body.indexOf("anime")==0 ||
event.body.indexOf("wibu")==0 ||
event.body.indexOf("waifu")==0 ||
event.body.indexOf("wibuchua")==0 ||
event.body.indexOf("Anime")==0 ||
event.body.indexOf("mp4anime")==0 ||
event.body.indexOf("animevip")==0) {
...
const fs = global.nodemodule["fs-extra"];
    var link = [
     ...
     var callback = () => api.sendMessage({body:"𝚅𝚒𝚍𝚎𝚘 𝙰𝚗𝚒𝚖𝚎 ┃ 𝙵𝚋 𝙰𝚍𝚖𝚒𝚗:https://www.facebook.com/vanchiendzs",attachment: fs.createReadStream(__dirname + "/cache/vd.mp4")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/vd.mp4"), event.messageID);
