...
if (!args[0]) return api.sendMessage({body:`= 𝐇𝐔̛𝐎̛́𝐍𝐆 𝐃𝐀̂̃𝐍 𝐒𝐔̛̉ 𝐃𝐔̣𝐍𝐆 =\n\n.𝘁𝗶𝗸𝘁𝗼𝗸 𝗶𝗻𝗳𝗼 < 𝗶𝗱 >: 𝗫𝗲𝗺 𝘁𝗵𝗼̂𝗻𝗴 𝘁𝗶𝗻 𝗻𝗴𝘂̛𝗼̛̀𝗶 𝗱𝘂̀𝗻𝗴\n\n.𝘁𝗶𝗸𝘁𝗼𝗸 𝘃𝗶𝗱𝗲𝗼 < 𝘀𝗮𝗼 𝗰𝗵𝗲́𝗽 𝗹𝗶𝗲̂𝗻 𝗸𝗲̂́𝘁 >: 𝗧𝗮̉𝗶 𝘃𝗶𝗱𝗲𝗼\n\n.𝘁𝗶𝗸𝘁𝗼𝗸 𝗺𝘂𝘀𝗶𝗰 < 𝘀𝗮𝗼 𝗰𝗵𝗲́𝗽 𝗹𝗶𝗲̂𝗻 𝗸𝗲̂́𝘁 >: 𝗧𝗮̉𝗶 𝐚̂𝗺 𝘁𝗵𝗮𝗻𝗵 𝗰𝘂̉𝗮 𝘃𝗶𝗱𝗲𝗼\n\n.𝘁𝗶𝗸𝘁𝗼𝗸 𝘀𝗲𝗮𝗿𝗰𝗵 < 𝘁𝘂̛̀ 𝗸𝗵𝗼́𝗮 >: 𝗧𝗶̀𝗺 𝗸𝗶𝗲̂́𝗺 𝘃𝗶𝗱𝗲𝗼 𝘁𝗵𝗼̂𝗻𝗴 𝗾𝘂𝗮 𝘁𝘂̛̀ 𝗸𝗵𝗼𝗮́\n\n.𝘁𝗶𝗸𝘁𝗼𝗸 𝘁𝗿𝗲𝗻𝗱𝗶𝗻𝗴: 𝗥𝗮𝗻𝗱𝗼𝗺 𝗻𝗵𝘂̛̃𝗻𝗴 𝘃𝗶𝗱𝗲𝗼 𝘁𝗿𝗲𝗻𝗱𝗶𝗻𝗴`,attachment: fs.createReadStream(__dirname + `/cache/tiktok.png`) }, event.threadID,event.messageID);
  ...
  switch (type.toLowerCase()) {
    ...
    case 'search':
      ...
      axios.get(`vitieubao.click/tiktok/searchvideo?keywords=${search}`).then(res => {
    ...
    case "video":
      try {
        const res = await axios.get(`vitieubao.click/tiktok/downloadvideo?url=${keyword}`);
    ...
    case "-tr":
    case "trending":
      axios.get(`vitieubao.click/tiktok/trendingtiktok`).then(response_api => {
