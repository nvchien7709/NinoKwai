...
"https://i.imgur.com/ZAQpg2f.jpg",
   ...
   var callback = () => api.sendMessage({body:`𝘼̉𝙣𝙝 𝙉𝙪𝙙𝙚\n𝙎𝙤̂́ 𝘼̉𝙣𝙝: ${link.length}`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"));  
